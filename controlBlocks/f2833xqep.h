...
------------------------------------------------------------------------------*/
#define QDECCTL_INIT_STATE     QSRC_QUAD_MODE
...
#define QEP_INIT_MACRO(m,v)																		\
     ...
     (*eQEP[m]).QUPRD = 1500000;		        	/* Unit Timer for 100Hz*/			     	\
...
/* Compute the mechanical angle */																\
	v.MechTheta= _IQmpyIQX(v.MechScaler,30,v.RawTheta,0);		/*IQ24*/	 				    \
/* Compute the electrical angle  */																\
    /*v.ElecTheta = (v.PolePairs*v.MechTheta) - _IQ30((v.PolePairs*v.MechTheta)>>30);*/         \
    v.ElecTheta = _IQmpyIQX(v.PolePairs,0,v.MechTheta,24);  /*IQ24*/                            \
    while (v.ElecTheta > _IQ(1.0)) v.ElecTheta = v.ElecTheta - _IQ(1.0);                        \
   																								\
